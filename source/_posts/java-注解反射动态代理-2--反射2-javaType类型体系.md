...
![](/images/blogimg/java/t/8.png)

无显式定义extends：

![](/images/blogimg/java/t/9.png)
...
![](/images/blogimg/java/t/10.png)

3. getName()

获取类型变量在源码中定义的名称

![](/images/blogimg/java/t/11.png)
...
![](/images/blogimg/java/t/13.png)

1. getUpperBounds()

获取泛型变量的上边界（extends）

![](/images/blogimg/java/t/14.png)

2. getLowerBounds

获取泛型变量的下边界（super）

![](/images/blogimg/java/t/15.png)