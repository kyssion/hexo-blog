---
title: postgresql-学习记录(2)-postgresql用户权限解析
date: 2024-12-31 20:38:00
...
![](/images/blogimg//blogimg/postgresql/1.png)

如图:
![](/images/blogimg//blogimg/postgresql/2.png)

在获取到客户端的OS用户名之后，PostgreSQL会通过pg_hba.conf中配置的map名与pg_ident.conf中配置的映射关系，以及客户端提供的数据库用户名，判断是否允许登陆数据库。
如图

![](/images/blogimg//blogimg/postgresql/3.png)
